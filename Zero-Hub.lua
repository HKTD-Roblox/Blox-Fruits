...
-- Luu script de re-execute khi doi ngon ngu
if not getgenv().TayHubLoaded then
    getgenv().TayHubLoaded = true
end

loadstring(game:HttpGet("https://raw.githubusercontent.com/hdanhhub/hdanhhub/refs/heads/main/Fix-Lag.lua.txt"))()
-- Luu URL script de re-execute khi doi ngon ngu
getgenv().TayHubScript = nil -- Se duoc set tu ben ngoai khi load
--[[
